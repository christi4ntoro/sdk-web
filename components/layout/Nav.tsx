      ...
      <nav className={`dk-nav ${scrolled ? 'dk-nav-scrolled' : 'dk-nav-top'}`}>
        ...
        <Link href="/" className="dk-nav-logo">
          ...
          >
            ...
            <path fill="#FF9900" d="M613.721 233.022C604.355 233.022 596.299 236.389 589.588 243.095C582.871 249.817 579.505 257.861 579.505 267.245C579.505 276.606 582.871 284.656 589.588 291.361C596.299 298.106 604.355 301.456 613.721 301.456C623.105 301.456 631.144 298.106 637.86 291.361C644.588 284.656 647.944 276.606 647.944 267.245C647.944 257.861 644.588 249.817 637.86 243.095C631.144 236.389 623.105 233.022 613.721 233.022Z" />
          </svg>
        </Link>
