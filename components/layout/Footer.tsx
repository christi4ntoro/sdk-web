    ...
    <footer className="dk-footer">
      <div className="dk-footer-top">
        ...
        <div className="dk-footer-brand">
          <svg height="28" viewBox="0 0 841 318" fill="currentColor"
          ...
          <div className='dk-footer-social'>
            <a href="https://www.linkedin.com/company/studio-deki"
              target="_blank" rel="noopener noreferrer"
              className="dk-footer-social-link"
              aria-label={t('footer.social_linkedin')}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M20.447 20.452H16.89v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a1.977 1.977 0 0 1-1.972-1.98 1.976 1.976 0 1 1 3.953 0 1.977 1.977 0 0 1-1.981 1.98zm1.979 13.019H3.36V9h3.956v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
              </svg>
            </a>
            <a href="https://www.instagram.com/studiodeki.co"
              target="_blank" rel="noopener noreferrer"
              className="dk-footer-social-link"
              aria-label={t('footer.social_instagram')}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
